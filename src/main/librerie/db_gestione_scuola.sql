...
INSERT INTO `allievo_in_classe` VALUES ('2023/2024','AADDDD55D55D555D',1,'A'),('2023/2024','ADDDDD31D33D313A',1,'A'),('2023/2024','ADDDDD44D44D444A',1,'A'),('2023/2024','ADDDDD55D33D333A',1,'A'),('2023/2024','ALLDDD04D33D333A',1,'B'),('2023/2024','SDDDDD55D55D555D',1,'B'),('2023/2024','ZDDDDD55D55D555D',1,'B'),('2023/2024','ZZZZZZ11Z11Z111Q',1,'B'),('2023/2024','ALDDDD01D33D333A',2,'A'),('2023/2024','ALDDDD55D55D555D',2,'A'),('2023/2024','ALZZZZ11Z11Z111Q',2,'A'),('2023/2024','DDDDDD55D55D555S',2,'A'),('2023/2024','NDDDDD55D55D555D',2,'A'),('2023/2024','ALDDDD00D33D333A',2,'B'),('2023/2024','ALDDDD02D44D444D',2,'B'),('2023/2024','ALIDDD99D33D333A',2,'B'),('2023/2024','DADDDD55D55D555D',2,'B');
...
CREATE TABLE `prova` (
  ...
  KEY `fk_prova_allievo` (`cf_allievo`),
  KEY `fk_prova_docente` (`cf_docente`),
  KEY `fk_prova_materia` (`nome_materia`),
  CONSTRAINT `fk_prova_allievo` FOREIGN KEY (`cf_allievo`) REFERENCES `allievo_in_classe` (`cf_allievo`),
  CONSTRAINT `fk_prova_docente` FOREIGN KEY (`cf_docente`) REFERENCES `docente_classe` (`cf_docente`),
  CONSTRAINT `fk_prova_materia` FOREIGN KEY (`nome_materia`) REFERENCES `docente_materia` (`nome_materia`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `prova` VALUES ('2024-05-25 18:56:46','ADDDDD31D33D313A','DDDDDD05D55D555D','Fisica',8,1),('2024-05-25 19:35:48','NDDDDD55D55D555D','DDDDDD55D55D550D','Italiano',8,1),('2024-05-25 19:38:54','ALDDDD02D44D444D','DDDDDD66D66D666D','Matematica',9,1),('2024-05-26 10:27:55','ALDDDD01D33D333A','DDDDDD05D55D555D','Fisica',9,1);
...
INSERT INTO `utente` VALUES ('docente2','docente2',1,2,NULL,'DDDDDD66D66D666D',NULL),('docente3','docente3',1,2,NULL,'DDDDDD55D55D550D',NULL),('user1','pass1',1,1,NULL,NULL,'ADDDDD33D33D333A'),('user2','pass2',1,2,NULL,'DDDDDD05D55D555D',NULL),('user3','pass3',1,3,'AAAAAA11A11A111A',NULL,NULL);
...
-- Dump completed on 2024-05-26 16:53:58
